...
- [Cooker Testing - Guide](https://retrodeck.readthedocs.io/en/latest/wiki_development/testing/retrodeck-testing/)

## Can I contribute to RetroDECK in some another way?

Yes, read more here:

- [How to Contribute](https://retrodeck.readthedocs.io/en/latest/wiki_credits_social/contibute-retrodeck/)
